...
logs <- as.tibble(fread('../input/user_logs.csv', nrows = 5e6))
```
...
The original `user_logs.csv` file takes up about 27 GB in uncompressed form; which is why here we only use the first 1% of this data (still 20 million rows). In this file we have the information about the listening behaviour of the users.
